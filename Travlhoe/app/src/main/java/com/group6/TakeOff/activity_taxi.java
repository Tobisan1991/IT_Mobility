...
public class activity_taxi extends AppCompatActivity {
    ...
    public void onButtonClicked(View v){
        ...
        if(v.getId()==R.id.goToGPS) {
            //Intent intent2 = new Intent(activity_taxi.this, function_gps.class );
            Intent intent2 = new Intent(activity_taxi.this, MapsActivity.class );
        ...
        btn_save.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        boolean isInserted = myDb.createTaxi(
                                selectedspinner,
                        ...
                        if(isInserted=true)
                            Toast.makeText(activity_taxi.this, "Daten gespeichert", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(activity_taxi.this, "Daten nicht gespeichert", Toast.LENGTH_LONG).show();
